use super::{cargo_toml, file::generate_file_content, lib_rs, types_rs::ModelsRsGenerator};
use crate::schemas;
use std::{collections::HashMap, fs, path::PathBuf};

pub struct PackageGenerator<'a> {
    types_rs_generator: ModelsRsGenerator<'a>,
}
...
impl<'a> PackageGenerator<'a> {
    pub fn new(
        ...
        Self {
            types_rs_generator: ModelsRsGenerator::new(intermediate_data, names),
        }
    }
